...
<head>
    ...
    <link href="{{ asset('flatkit/assets/styles/font.css') }}" rel="stylesheet" type="text/css" />
    <!-- style -->
    <link href="{{ asset('css/app.css') }}" type="text/css" />
    <link href="{{ asset('flatkit/assets/glyphicons/glyphicons.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('flatkit/assets/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('flatkit/assets/material-design-icons/material-design-icons.css') }}"  rel="stylesheet"type="text/css" />

    <link href="{{ asset('flatkit/assets/bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- build:css ../assets/styles/app.min.css -->
    <link href="{{ asset('flatkit/assets/styles/app.css') }}" rel="stylesheet" type="text/css" />
    <!-- endbuild -->
    <link href="{{ asset('flatkit/assets/styles/font.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('trumbowyg/ui/trumbowyg.css') }}" rel="stylesheet" type="text/css" />
