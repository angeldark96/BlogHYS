<header class="cd-main-header">
    ...
    <ul class="cd-header-buttons">
        <li><a class="cd-nav-trigger" href="">
			 <span>
			 </span>
            </a></li>
                   ...
                   --}}{{-- @foreach($posts as $post)
                    <li>
                        <a class="cd-nav-item" href="">
                            ...
                            <img src="/img/posts/{{  $post->images->isEmpty() ?'default-img.gif' : $post->images()->first()->name }}" alt="" style="width: 272px;height: 204px;object-fit: cover">
